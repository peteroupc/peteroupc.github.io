...
5. Otherwise:
    1. Generate an unbiased random bit, call it _d_. Create a positive-sign zero-integer-part uniform PSRN, call it _ret.
...
1. Set _i_ to 0, and set **b** to a positive-sign zero-integer-part uniform PSRN.
