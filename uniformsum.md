...
4. Generate an unbiased random bit, call it _d_.
5. If the base of **a**'s and **b**'s digits is 2, and if **c** is non-negative:
    1. Generate unbiased random bits until 0 is generated this way.  Set _g_ to the number of one-bits generated by this substep.
