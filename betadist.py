...
class PhaseType:
    ...
    # s - Subgenerator matrix.  List of N lists with N items each.
...
class ShapeSampler2:
    ...
    def _makepsrn(self, coord, rg):
        ...
        # Moreover, coords are assumed to be nonnegative.
...
# nondeterministic (it doesn't always return the same
# value for the same input).
# And this is why nonreproducibility can happen
