...
2. Instructional materials should:
    ...
    - Devote most time to instruction that is interactive (teacher and students take turns), where the teacher explains concepts fully and models procedures fully before getting students to apply those concepts and procedures. [^2]
    - Assign review questions in class at least once a week using the theory of spaced and interleaved retrieval practice (for example, a quiz of randomly arranged questions from [**last lesson, last week, last unit, and course-so-far**](https://x.com/SuzanneRelou/status/1878428245252558888)).
