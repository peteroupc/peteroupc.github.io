...
Perhaps the most familiar example of randomness extraction is the one by von Neumann (1951)<sup>[**(4)**](#Note4)</sup>, which works if "independence of successive [coin] tosses is assumed"<sup>[**(17)**](#Note17)</sup>:
...
- <small><sup id=Note17>(17)</sup> However, this method and Peres's extractor also works if the coin tosses are _exchangeable_, which roughly means that changing the order of the tosses doesn't change their overall bias (Peres 1992).</small>
