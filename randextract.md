...
Perhaps the most familiar example of randomness extraction is the one by von Neumann (1951\)<sup>[**5**](#Note5)</sup>, which works if "independence of successive [coin] tosses is assumed"[^6]:
