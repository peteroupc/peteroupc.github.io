...
plugins=%w( postcss-import cssnext postcss-colormin postcss-minify-font-values
   autoprefixer postcss-merge-longhand postcss-minify-selectors
...
cmd+=" --postcss-discard-comments.removeAll true -o ../style.css"
puts cmd
`#{cmd}`
