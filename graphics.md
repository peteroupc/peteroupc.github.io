...
3. Tiles have the same width and the same height (32 &times; 32 pixels or smaller). 8 &times; 8 pixels is the suggested width and height, but the width and height need not be a power of 2.
