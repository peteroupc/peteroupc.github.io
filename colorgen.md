...
<sup id=Note22>(22)</sup> `Lerp3` is equivalent to `mix` in GLSL (OpenGL Shading Language).  Making `alpha` the output of a function (for example, `Lerp3(color1, color2, FUNC(...))`,
