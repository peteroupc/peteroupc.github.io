...
>     - if that number is greater than a maximum threshold, use the maximum threshold instead (_right-censoring).
>
>     An example of a clamped random number is `min(200, RNDINTRANGE(1, 255))`.
