...
- [**General Non-Uniform Distributions**](#General_Non_Uniform_Distributions)
    ...
    - [**Transformations of Random Numbers**](#Transformations_of_Random_Numbers)
        - [**Censored Random Numbers**](#Censored_Random_Numbers)
...
- whether a random number is not greater than a minimum threshold (_right-truncation_),
...
<a id=Censored_Random_Numbers></a>
#### Censored Random Numbers
