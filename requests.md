...
7. Are there relatively simple Monte Carlo simulations whose expected value ("average" value) is an irrational number in [0, 1]?  For an example, see the 1/_&pi;_ algorithm on the Bernoulli Factory Algorithms page.
