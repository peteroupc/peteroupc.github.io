...
Counter-based PRNGs, in which their state is updated simply by incrementing a counter, can be trivially jumped ahead just by changing the seed and/or the counter (Salmon et al. 2011)<sup>[**(4)**](#Note4)</sup>.
