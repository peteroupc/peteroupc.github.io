...
/** @ignore */
  QuickHull._MeshBuilder = function(a, b, c, d) {
    ...
    this.toMesh = function(points) {
      ...
      if(faceStack.length === 0)return mesh;
      while(faceStack.length > 0) {
        ...
        if(faceProcessed[top]) {
          ...
          mesh.vertex3(points[vertices[0]])
          .vertex3(points[vertices[1]])
          .vertex3(points[vertices[2]]);
        }
      }
      return mesh;
    };
