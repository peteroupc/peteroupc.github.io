...
**Corollary 1:** _The function f(&lambda;) = &lambda;<sup>m/(2<sup>_n_</sup>)</sup>, where n &ge; 1 is an integer and where _m_ &ge; 1 is an integer, can be simulated by a pushdown automaton._
