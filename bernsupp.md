...
Let **E**\[_N_\] be the expected number of unbiased random bits (fair coin flips) generated by the algorithm.
...
A similar analysis to the one above can be used to find the expected time complexity of many Bernoulli factory algorithms.
