...
[^39]: Cichoń, Jacek, et al. "On delta-method of moments and probabilistic sums." 2013 Proceedings of the Tenth Workshop on Analytic Algorithmics and Combinatorics (ANALCO). Society for Industrial and Applied Mathematics, 2013.

[^40]: Mattner, Lutz, and Jona Schulz. "On normal approximations to symmetric hypergeometric laws." Transactions of the American Mathematical Society 370.1 (2018): 727-748.
...
(See also Cichoń et al. (2013)[^39].) Therefore&mdash;
...
$X$ is symmetric about its mean (Mattner and Schulz 2018)[^40] and can take on values in the closed interval $[0, n]$, since there are at most $n$ "good" balls.
