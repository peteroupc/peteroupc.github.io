...
[^47]: Shvartsman, Pavel. "[**Sobolev functions on closed subsets of the real line: long version**](https://arxiv.org/pdf/1808.01467)", arXiv:1808.01467 (2018)

[^48]: Favard J., "Sur l’interpolation", _J. Math. Pures Appl._ 19 (1940).

[^49]: De Boor, C., "On 'Best' Interpolation", _Journal of Approximation Theory_ 16 (1976).
...
_Proof_: If $k\gt n$, rewrite $X$ to a hypergeometric($2n$, $n$, $k$) random variable, which has the same distribution as the original, and set $k = n$, since the sample size is now $n$. (See also Johnson et al. (2005)[^50].)  Now it can be assumed without loss of generality that $0\le k\le n$.
