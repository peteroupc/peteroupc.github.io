...
The proof follows from combining Kindler and Romik (2004, Theorem 2)[^56] and Knuth and Yao (1976)[^35] with Richman (2012)[^61], who proved that a continuous algebraic function on an open interval is piecewise analytic ("analytic" means writable as $c_0 x^0+ ... +c_i x^i + ...$ where $c_i$ are real numbers).
