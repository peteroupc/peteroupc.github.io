...
5. If _fraction_ is 0 and if **a** and **b** are both negative or both non-negative, then it was detected to be a _base_-adic rational number, which enables an "exact" multiplication.  In this case, do the following:
