...
- [**Poisson Distribution with Mean 1**](#Poisson_Distribution_with_Mean_1)
- [**Notes**](#Notes)
- [**License**](#License)
...
<a id=Poisson_Distribution_with_Mean_1></a>
## Poisson Distribution with Mean 1

An interesting algorithm in (Duchon and Duvignau 2014)<sup>[**(37)**](#Note37)</sup> generates a Poisson random variate with mean 1 using only integers, and not floating-point or irrational numbers.  With this algorithm, a Poisson random variate with positive integer mean _n_ can be generated by summing _n_ Poisson variates with mean 1.
...
- <small><sup id=Note37>(37)</sup> Duchon, P. and Duvignau, R., 2014, June. "A new generation tree for permutations, preserving the number of fixed points", in _Discrete Mathematics and Theoretical Computer Science_ (pp. 679-690).</small>
