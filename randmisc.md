...
- Pérez-Casany et al. (2016)<sup>[**(21)**](#Note21)</sup> calls a distribution of minimums or of maximums a _random-stopped extreme distribution_.
- A distribution of sums can be called a _stopped-sum distribution_ (Johnson et al. 2005)<sup>[**(22)**](#Note22)</sup>. (In this case, _N_ can be 0 so that _N_ &ge; 0 is an integer distributed as _Y_.)
