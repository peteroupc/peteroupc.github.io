...
> **Notes:**
>
> - A binomial(_n_, 1/2) random variate, where _n_ is odd[^2], can be generated by outputting a binomial(_n_&minus;1, 1/2) random variate plus either 1 or 0 with equal probability.
