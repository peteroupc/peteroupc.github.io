...
> **Note:** I suspect that if the quantile function is bounded and continuous, and admits a modulus of continuity _&omega;_(_h_) that is monotone increasing, then _d_ in step 1 above can be calculated as ceil(&minus;ln(_&omega;_<sup>&minus;1</sup>(_&epsilon;_))/ln(_&beta;_)), where _&omega;_<sup>&minus;1</sup>(_h_) is the inverse of the modulus of continuity.  (Loosely speaking, a modulus of continuity shows the quantile function's maximum range in a window of size _h_.)
