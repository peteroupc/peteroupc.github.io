...
Another algorithm to sample this probability, which appears in French in (Penaud and Roques 2002)<sup>[**(58)**](#Note58)</sup>, is iterative but requires arithmetic operations.
...
- <small><sup id=Note58>(58)</sup> Penaud, J.G., Roques, O., "Tirage à pile ou face de mots de Fibonacci", _Discrete Mathematics_ 256, 2002.</small>
