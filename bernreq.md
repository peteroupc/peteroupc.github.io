...
>
> 4. For every $r\ge 2$, if the sequence $(W_n)$ is such that $B_n(W_n(f))$ preserves all polynomials of degree $r$ or less, then $B_n(W_n(f))$ must be nonlinear, nonpositive, or nonanalytic (Gavrea and Ivan 2018)[^20], which implies that $(W_n)$ cannot be a sequence of linear positive operators (Finta 2013)[^21].
